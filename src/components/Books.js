...
import { deleted, edited } from '../redux/Books/action';
      ...
      <div class="flex-1 h-full pr-2 pt-2 flex flex-col">
        <div class="flex items-center justify-between">
          ...
          <div class="text-gray-500 space-x-2">
            <button class="lws-edit" onClick={() => handleEdit(book)}>
        ...
        <div class="space-y-2 mt-4 h-full">
          ...
          <div class="lws-stars">
            {bookShow.forEach(book => <BookStar></BookStar>)}
          </div>
